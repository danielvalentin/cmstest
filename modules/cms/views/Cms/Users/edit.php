	...
	<div class="row">
		<div class="col-xs-12 col-md-9">
			...
			<div class="form-group">
				...
				<div class="form-group" data-bind="if:user.avatar.id()!='0'">
					<img src="" data-bind="src:user.avatar.img.medium()" />
				</div>
				<div class="form-group" data-bind="if:user.avatar.id()=='0'">
					<div>
				...
				<div class="filebrowserwrap">
					<input type="hidden" name="file_id" data-bind="value:user.avatar.id" />
					<button data-bind="filebrowserbtn:{callback:setAvatarId,limit:1}" type="button" class="btn filebrowserbtn">
						<span class="glyphicon glyphicon-file"></span>
						<?php echo __('Select file') ?>
					</button> (<a href="#" data-bind="click:clearAvatar"><?php echo __('clear'); ?></a>)
				</div>
			</div>
			<div class="form-group">
