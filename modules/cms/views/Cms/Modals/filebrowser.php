					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-xs-3 filebrowser-info">
								<div data-bind="visible:currentfile()">
					...
					<div class="modal-footer">
						<div class="row-fluid">
							...
							<div class="col-xs-6 text-right">
								...
								<button class="btn btn-primary insert-files-btn" id="filebrowser-insert-files-btn" data-bind="click:insertFiles"><?php _e('Select all') ?></button>
							</div>
						</div>
					</div>
