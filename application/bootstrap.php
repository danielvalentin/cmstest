...
Kohana::$base_url = $site->get('base');
date_default_timezone_set($site->get('default_timezone'));
setlocale(LC_ALL, $site->get('locale').'.'.$site->get('charset'));
...
Cookie::$salt = Kohana::$config->load('secrets')->get('cookie_salt');
